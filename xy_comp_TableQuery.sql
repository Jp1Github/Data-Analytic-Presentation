...
FROM employee AS emp
JOIN employeePosition AS empP ON emp.position_ID = empP.position_ID
JOIN employeeSalary AS empS ON emp.employeeID = empS.employeeID )
...
SELECT position_ID, jobTitle, COUNT(employeeID) AS TotalEmployees,
...
SELECT jobTitle, lastName, salary_Per_Month,
